...
I tried several options, including boxplot, but due to very large outliers the best option seems to be an histogram on the log scale:
...
# First, let's read the data
patients <- 
  read_csv(paste0(mimic_path,"/core/patients.csv.gz"))
```
